...
Tags: email marketing, email builder, newsletter, newsletters, campaigns, subscribers, subscription, manage subscribers,  marketing, drip, mailget, formget 
Requires at least: 3.5.0
Tested up to: 4.7.2
Stable tag: 1.4

MailGet - Email Marketing WordPress plugin gives you highest inbox email delivery at affordable price. Track Open, Clicks, Spam, Bounce.

== Description ==
[MailGet](https://www.formget.com/mailget) is a smart platform for email marketers and the best email marketing WordPress plugin solution available over internet. It has very low price i.e. 100x cheaper as compared to other mailing services.
...
* **[Powerful Responsive Email Builder](http://www.formget.com/email-builder/) -** We tested our mails in all email service provide like Gmail, Yahoo, HotMail, AOL and many more to check that email receive in good format.
...
* **[Email Personalization Tag](http://www.formget.com/email-marketing-personalization/) -** You can send email to your customer with personalization like Hello {first} First name, Last Name, Complete Name. 
* **[Email Optin Form / Embeddable web forms](http://www.formget.com/generate-embed-web-form-to-collect-subscribers/)-** We have optin form available for user where user can put the subscription form on there website to get leads directly. 
* **[Email Automation / Auto responder](http://www.formget.com/autoresponder-email/) -** When ever a user subscribe on your website Auto Responder help you to send him to follow up emails.
* **[Drip Email Marketing](http://www.formget.com/create-effective-email-drip-campaigns/) -** Let says you want to set a drip campaign of 10 emails to your users and want to send them on a particular date to time then drip email help you to send email in sequence. 
* **[Email List Clean Up](http://www.formget.com/clean-email-list/) -** When every you import list to your system them you can easily clean you your list with just a click of button. We have create a very advance and powerful system for list clean. 
...
* **[Email SMTP](http://www.formget.com/configure-multiple-smtp-with-mailget/) -** MailGet has powerful feature connect with any SMTP service to send emails. Right now we connected Amazon SES, Mandrill, MailGun, MailJet, SendGrid, PostMark or you can also integrate with any SMTP email service of your choice. 
* **[List Import](http://www.formget.com/import-contacts-list-on-mailget/) -** Upload Email List and make sure to clean your list.
* **High Delivery -** Connect with any SMPT to get maximum delivery. MailGet is best to achieve maximum delivery.
* **[MailGet API](http://www.formget.com/email-newsletter-subscribe-signup-form-api/) -** MailGet provides API to integrate your website’s signup form with your MailGet account. You have to download our API from your MailGet dashboard and put some PHP  code on your signup form code. When anybody will signup at your website his/her contact information will automatically sync with your desired MailGet contact list, you don’t need to import any list for that data.

MailGet helps you to stay connected with your user with the most friendly way.

Visit our site [MailGet](https://www.formget.com/mailget) for more information.
